          ...
          return snapshot.data!.docs.isEmpty
              ? Center(
                  child: Constant.showEmptyView(
                      message: "No Completed Parking Found"),
                )
              : ListView.builder(
                  itemCount: snapshot.data!.docs.length,
                  itemBuilder: (context, index) {
                    BookingModel bookingModel = BookingModel.fromJson(
                    ...
                    return Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            Get.toNamed(Routes.BOOKING_SUMMARY_SCREEN,
