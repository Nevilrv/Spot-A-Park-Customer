    ...
    return GetX<LanguageScreenController>(
        ...
        builder: (controller) {
          return Scaffold(
            ...
            appBar: UiInterface().customAppBar(context, "Change Language".tr,
                isBack: true, backgroundColor: AppColors.white),
            ...
            bottomNavigationBar: controller.languageList.isEmpty
                ? const SizedBox()
                : Container(
                    padding: const EdgeInsets.symmetric(
