            ...
            actions: [
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    if (controller.parkingModel.value.likedUser!
                        .contains(FireStoreUtils.getCurrentUid())) {
                      controller.parkingModel.value.likedUser!
                  ...
                  child: (controller.parkingModel.value.likedUser!
                          .contains(FireStoreUtils.getCurrentUid()))
                      ? const Icon(
                          Icons.favorite,
                          color: Colors.red,
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount:
                                  controller.parkingModel.value.images!.length,
                                ...
                                return Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: NetworkImageWidget(
                                      ...
                                      borderRadius: 12,
                                      imageUrl: controller
                                          .parkingModel.value.images![index],
                                      fit: BoxFit.fill,
                                    ),
                                  ),
                                );
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                InkWell(
                                  onTap: () {
                                    Constant.redirectMap(
                                        controller.parkingModel.value.location!
                                            .latitude!,
                                        controller.parkingModel.value.location!
                                            .longitude!);
                                  },
                            ...
                            Row(
                              children: [
                                SvgPicture.asset(
                                  (controller.parkingModel.value.parkingType ==
                                          "4")
                                ...
                                Text(
                                  '${controller.parkingModel.value.parkingType} Wheel'
                                      .tr,
                                  style: const TextStyle(
                                    color: AppColors.darkGrey06,
                                    fontFamily: AppThemData.bold,
                                ...
                                Text(
                                  Constant.calculateReview(
                                      reviewCount: controller
                                          .parkingModel.value.reviewCount,
                                      reviewSum: controller
                                          .parkingModel.value.reviewSum),
                                  style: const TextStyle(
                                    color: AppColors.darkGrey06,
                                    fontFamily: AppThemData.bold,
                                  ),
                              ...
                              children: [
                                ParkingInformationWidget(
                                  imageAsset:
                                      "assets/icons/ic_place_marker.svg",
                                  value:
                                      "${controller.parkingModel.value.parkingSpace} Slots Available",
                                ),
                                ParkingInformationWidget(
                                  imageAsset: "assets/icons/ic_clock.svg",
                                  value:
                                      "${controller.parkingModel.value.startTime} - ${controller.parkingModel.value.endTime}",
                                ),
                                ParkingInformationWidget(
                                  imageAsset: "assets/icons/ic_call.svg",
                                  value:
                                      "${controller.parkingModel.value.countryCode} ${controller.parkingModel.value.phoneNumber}",
                                )
                              ],
                            ),
                            const SizedBox(
                            ...
                            controller.parkingModel.value.facilities!.isNotEmpty
                                ? Column(
                                    children: List.generate(
                                        controller.parkingModel.value
                                            .facilities!.length, (index) {
                                      ParkingFacilitiesModel facilities =
                                          controller.parkingModel.value
                                              .facilities![index];
                                      return Padding(
                                        padding:
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ButtonThem.buildButton(
                          ...
                          onPress: () {
                            Get.toNamed(Routes.CHOOSE_DATE_TIME_SCREEN,
                                arguments: {
...
class ParkingInformationWidget extends StatelessWidget {
  ParkingInformationWidget(
      {super.key, required this.value, required this.imageAsset});
